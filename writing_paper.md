...
Before writing a paper using markdown file, a [YAML header](https://zsmith27.github.io/rmarkdown_crash-course/lesson-4-yaml-headers.html) is quite useful for defining the format of the paper. Here is an example of YAML header for writing a journal article of [hp36_cross_correlation git repo](https://github.com/yamatolab/hp36_cross_correlation/tree/main/paper):
